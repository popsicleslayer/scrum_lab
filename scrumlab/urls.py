...
from jedzonko.views import (index_site, DashboardView, IndexView, RecipeListView, RecipeAddView, RecipeModifyView,
                            PlanIdView, PlanAddView, PlanAddReceipeView, PlanListView, RecipeDetails)
